...
(check-expect (map2 string-length (list "David" "Guetta")) (list 5 6))
...
;; Given a list and a predicate, produce a list of elements for which the predicate returns true
